...
include_once('_cms/autoload.php');
...
class MultiTenancyMiddleware extends Middleware
{
    ...
    private function handleRecord(Request $request, String $operation, array $pairs) 
    {
        $record = $request->getBody();
        if ($record === null) {
            return;
...
class OpenApiBuilder
{
    ...
    private function setTag(int $index, String $tableName) 
    {
...
$settings = [
    'driver' => 'mysql',
    'address' => 'localhost',
    'database' => 'feliphegomez_cms',
    'username' => 'feliphegomez_cms',
    'password' => 'feliphegomez_cms',
    ...
    'debug' => true,
	'openApiBase' => '{"info":{"title":"COMASY API Rest","version":"1.0.0"}}',
];
